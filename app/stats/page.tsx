...
export default function StatsPage() {
  const { profile, completedQuizzes, resetData } = useQuizStore()
  ...
  // Generate streak calendar dots (last 7 days representation)
  const streakDays = []
  ...
  for (let i = 6; i >= 0; i--) {
    ...
    const isToday = i === 0
    const completedStr = d.toISOString().split("T")[0]
    ...
    <div className="min-h-screen bg-background text-on-background lg:flex">
      ...
      <main className="flex-1 mt-[72px] mb-[88px] lg:mt-0 lg:mb-0 lg:ml-64 p-6 md:p-12 w-full max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 w-full animate-pop-in">
          ...
          <div className="md:col-span-8 bg-surface-container-lowest border border-outline-variant/30 rounded-3xl p-6 md:p-8 shadow-sm flex flex-col justify-between gap-6">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-full bg-primary-container text-on-primary-container font-display text-xl font-bold flex items-center justify-center shrink-0 shadow-sm">
                {initials}
              </div>
              <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="w-full h-4 bg-surface-container rounded-full overflow-hidden p-[2px] border border-outline-variant/20">
                <div 
          ...
          <div className="md:col-span-4 bg-surface-container-lowest border border-outline-variant/30 rounded-3xl p-6 shadow-sm flex flex-col justify-around gap-6">
          ...
          <div className="md:col-span-6 bg-surface-container-lowest border border-outline-variant/30 rounded-3xl p-6 shadow-sm flex flex-col gap-4">
